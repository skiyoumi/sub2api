...
func DomainGroupModelAllowlist(cfg GroupModelAllowlist) domain.GroupModelAllowlist {
	return domain.GroupModelAllowlist{Enabled: cfg.Enabled, Models: cfg.Models, CCSwitchDefaults: cfg.CCSwitchDefaults}
}
...
func GroupModelAllowlistFromDomain(cfg domain.GroupModelAllowlist) GroupModelAllowlist {
	return GroupModelAllowlist{Enabled: cfg.Enabled, Models: cfg.Models, CCSwitchDefaults: cfg.CCSwitchDefaults}
}
...
func normalizeGroupModelAllowlist(cfg GroupModelAllowlist) (GroupModelAllowlist, error) {
	out := GroupModelAllowlist{Enabled: cfg.Enabled, CCSwitchDefaults: normalizeGroupCCSwitchDefaults(cfg.CCSwitchDefaults)}
	if len(cfg.Models) == 0 {
		if out.Enabled {
