...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		RegistrationIPLimit:                                    settings.RegistrationIPLimit,
		RegistrationIPWhitelist:                                settings.RegistrationIPWhitelist,
		...
		SidebarMenuOrder:                                       service.ParseSidebarMenuOrder(settings.SidebarMenuOrder),
		...
		PaymentRechargePackagesEnabled:                         paymentCfg.RechargePackagesEnabled,
		PaymentAllowCustomRechargeAmount:                       paymentCfg.AllowCustomRecharge,
