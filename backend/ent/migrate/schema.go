...
var (
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "recharge_package_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "base_amount", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "permanent_credit_amount", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "bonus_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "bonus_validity_days", Type: field.TypeInt, Default: 0},
		{Name: "bonus_expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "recharge_package_snapshot", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "recharge_bonus_disabled", Type: field.TypeBool, Default: false},
