...
func init() {
	...
	// paymentorderDescRechargePackageID is the schema descriptor for recharge_package_id field.
	paymentorderDescRechargePackageID := paymentorderFields[8].Descriptor()
	// paymentorder.RechargePackageIDValidator is a validator for the "recharge_package_id" field. It is called by the builders before save.
	paymentorder.RechargePackageIDValidator = paymentorderDescRechargePackageID.Validators[0].(func(string) error)
	// paymentorderDescBonusAmount is the schema descriptor for bonus_amount field.
	paymentorderDescBonusAmount := paymentorderFields[11].Descriptor()
	...
	// paymentorderDescBonusValidityDays is the schema descriptor for bonus_validity_days field.
	paymentorderDescBonusValidityDays := paymentorderFields[12].Descriptor()
	// paymentorder.DefaultBonusValidityDays holds the default value on creation for the bonus_validity_days field.
	paymentorder.DefaultBonusValidityDays = paymentorderDescBonusValidityDays.Default.(int)
	// paymentorderDescOutTradeNo is the schema descriptor for out_trade_no field.
	paymentorderDescOutTradeNo := paymentorderFields[15].Descriptor()
	...
	paymentorderDescPaymentType := paymentorderFields[16].Descriptor()
	...
	paymentorderDescPaymentTradeNo := paymentorderFields[17].Descriptor()
	...
	paymentorderDescOrderType := paymentorderFields[21].Descriptor()
	...
	// userDescRechargeBonusDisabled is the schema descriptor for recharge_bonus_disabled field.
	userDescRechargeBonusDisabled := userFields[16].Descriptor()
	// user.DefaultRechargeBonusDisabled holds the default value on creation for the recharge_bonus_disabled field.
	user.DefaultRechargeBonusDisabled = userDescRechargeBonusDisabled.Default.(bool)
