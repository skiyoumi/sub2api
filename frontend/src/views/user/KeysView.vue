          ...
          >
            <template #dropdown-header>
              ...
              >
                ...
                <button
                  v-for="platform in availableCreateGroupPlatforms"
                  :key="platform"
                  type="button"
...
const availableCreateGroupPlatforms = computed(() => showEditModal.value
  ? availableGroupPlatforms.value
  : availableGroupPlatforms.value.filter((platform) => getKeyGroupProvider(platform) === createProvider.value)
)

const formGroupOptions = computed(() => showEditModal.value
  ? createGroupOptions.value
  : createGroupOptions.value.filter((group) => getKeyGroupProvider(group.platform) === createProvider.value)
)
