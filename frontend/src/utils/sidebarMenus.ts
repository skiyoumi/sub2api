...
const builtInSidebarMenus: Record<SidebarSection, SidebarMenuEntry[]> = {
  user: [
    ...
    { path: '/subscriptions', labelKey: 'nav.mySubscriptions', icon: 'CreditCardIcon', hideInSimpleMode: true, feature: 'subscription' },
  ...
  admin: [
    ...
    { path: '/admin/subscriptions', labelKey: 'nav.subscriptions', icon: 'CreditCardIcon', hideInSimpleMode: true, feature: 'subscription' },
