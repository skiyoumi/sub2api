export default {
    settings: {
      ...
      registration: {
        ipWhitelist: 'Registration IP whitelist',
        ipWhitelistHint: 'One IP or CIDR per line. Whitelisted addresses bypass the per-IP registration limit.',
        ...
        ipLimit: 'Accounts per IP',
        ipLimitHint: 'Maximum accounts that can be registered from one IP. 0 disables the limit.',
      ...
      simpleModeOnly: 'Simple mode only',
        ...
        openModeHint: 'Open the link directly in a new tab, useful for websites that do not allow embedding.',
        url: 'Page URL',
      ...
      payment: {
        ...
        rechargePackagesTitle: 'Recharge Packages',
        rechargePackagesHint: 'Amounts and bonus rules are snapshotted when an order is created. Bonus balance expires after the configured days.',
        rechargePackagesEnabled: 'Enable packages',
        allowCustomRecharge: 'Allow custom amount',
        addRechargePackage: 'Add package',
        noRechargePackages: 'No recharge packages configured.',
        packageAmount: 'Recharge amount',
        packageBonus: 'Bonus balance',
        packageDays: 'Validity days',
