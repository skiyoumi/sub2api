export default {
    ...
    users: {
      ...
      bonusValidityDays: 'Bonus Validity',
      bonusValidityHint: 'Bonus balance is spent first and expires automatically after the validity period.',
      bonusValidityInvalid: 'Bonus validity must be between 1 and 3650 days',
      days: 'days',
      ...
      typePackageBalance: 'Balance (Package)',
