export default {
  ...
  payment: {
    ...
    rechargePackages: {
      title: 'Choose a recharge package',
      cashierTitle: 'Cashier',
      cashierSubtitle: 'Secure cashier · Official recharge channel',
      encrypted: 'Encrypted',
      chooseAmount: 'Choose recharge amount',
      chooseAmountHint: 'Choose a package or enter a custom amount. Credit is added automatically after payment.',
      maximum: 'Maximum {amount}',
      chooseMethod: 'Choose payment method',
      chooseMethodHint: 'Complete payment securely after the order is created.',
      custom: 'Custom amount',
      recommended: 'Recommended',
      bonus: 'Bonus {amount}, valid for {days} days',
      officialCredit: 'Recharge credit',
      instantCredit: 'Instant credit',
      bonusPolicyTitle: 'Bonus policy',
      bonusPolicyDescription: 'Bonus balance is spent first and expires automatically after the displayed validity period.',
      bonusLabel: 'Limited-time bonus',
      changed: 'Recharge packages changed. Please confirm again.',
      currentBonus: 'Bonus balance ${amount}',
      bonusExpiry: '${amount} expires at {date}',
      balanceAfter: 'Balance after recharge',
      confirmPay: 'Pay {amount}',
      confirmPayShort: 'Confirm payment',
      helpTitle: 'Need help with recharge?',
      contactService: 'Contact support',
      riskNotice: 'Personal payment channels may occasionally trigger risk controls. Retry a few times, or contact the administrator if in-site recharge remains unavailable.',
    },
