export default {
  ...
  payment: {
    ...
    rechargePackages: {
      title: '选择充值套餐',
      cashierTitle: '收银台',
      cashierSubtitle: '安全收银台 · 官方充值通道',
      encrypted: '已加密保护',
      chooseAmount: '选择充值金额',
      chooseAmountHint: '选择套餐或输入自定义金额，到账后自动计入账户余额',
      maximum: '最高 {amount}',
      chooseMethod: '选择支付方式',
      chooseMethodHint: '订单创建后进入安全支付页完成付款',
      custom: '自定义金额',
      recommended: '推荐',
      bonus: '赠送 {amount}，{days} 天有效',
      officialCredit: '官方充值额度',
      instantCredit: '实时到账',
      bonusPolicyTitle: '赠送说明',
      bonusPolicyDescription: '赠送余额优先抵扣，并在标注的有效期后自动失效。',
      bonusLabel: '限时赠送',
      changed: '充值套餐已更新，请重新确认',
      currentBonus: '赠送余额 ${amount}',
      bonusExpiry: '其中 ${amount} 将于 {date} 到期',
      balanceAfter: '充值后余额',
      confirmPay: '确认支付 {amount}',
      confirmPayShort: '确认支付',
      helpTitle: '充值遇到问题？',
      contactService: '联系客服',
      riskNotice: '因个人收款码可能出现风控问题，如遇支付风险可以多尝试几次；仍无法站内充值时，请联系管理员处理。',
    },
    refundReason: '退款原因',
