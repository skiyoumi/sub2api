export default {
    settings: {
      ...
      customItem: '自定义',
      unnamedItem: '未命名菜单',
      simpleModeOnly: '仅简洁模式',
        title: '自定义菜单页面',
        description: '添加自定义页面或链接到侧边栏，可选择打开方式和可见角色。',
        itemLabel: '菜单项 #{n}',
        name: '菜单名称',
        ...
        openModeIframe: '内嵌页面',
        openModeNewTab: '新标签页',
        openModeHint: '选择新标签页后，点击菜单将直接打开链接，适合不支持内嵌的网站。',
        url: '页面 URL',
      ...
      payment: {
        ...
        rechargePackagesTitle: '充值套餐',
        rechargePackagesHint: '金额和赠送规则在下单时固化；赠送余额按填写天数过期。',
        rechargePackagesEnabled: '启用套餐',
        allowCustomRecharge: '允许自定义金额',
        addRechargePackage: '新增套餐',
        noRechargePackages: '暂无充值套餐。',
        packageAmount: '充值金额',
        packageBonus: '赠送余额',
        packageDays: '有效天数',
        packageRecommended: '推荐',
        packageEnabled: '启用',
        orderTimeout: '订单超时时间',
